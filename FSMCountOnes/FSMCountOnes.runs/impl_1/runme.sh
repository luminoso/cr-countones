...
HD_PWD='/home/luminoso/UA-work/CR/projectofinal/FSMCountOnes/FSMCountOnes.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Count_Ones.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Count_Ones.tcl -notrace
